...
async def ask(ctx: dict, prompt: str, *, max_tokens: int = 1024,
              temperature: float = 0.35) -> str:
    """Chamada genérica (ex.: assistente noturno)."""
    return await _ask(ctx, prompt, max_tokens=max_tokens, temperature=temperature)
